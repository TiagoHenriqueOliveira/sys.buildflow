...
class AtendimentoRequest extends FormRequest
{
    ...
    {
        return [
            'aten_tp_atendimento_id' => ['required', 'integer'],
    ...
    {
        return [
            'aten_tp_atendimento_id.required' => 'Selecione o tipo de atendimento.',
            ...
            'aten_dt_fim.after_or_equal' => 'A data final não pode ser menor que a inicial.',
        ];
    }
}
